...
public class PlayerShootGolem extends AbstractAction {

	private double damage;
	private String golemOwner;
	private double golemHealth;

	public PlayerShootGolem(long time, PlayerState mainPlayer, double damage, String golemOwner, double golemHealth) {
